/*
https://pepcoding.com/resources/online-java-foundation/generic-tree/ceil-and-floor-official/ojquestion
...
public class Main {
  ...
  public static void ceilAndFloor(Node node, int data) {
    if((ceil == Integer.MAX_VALUE && node.data > data) || (node.data > data && node.data < ceil)){
        ceil = node.data;
    }
    
    if((floor == Integer.MIN_VALUE && node.data < data) || (node.data < data && node.data > floor)){
        floor = node.data;
    }
