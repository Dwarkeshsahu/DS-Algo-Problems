/*
https://pepcoding.com/resources/online-java-foundation/generic-tree/pred-succ-generic-tree-official/ojquestion
...
public class Main {
  ...
  static Node temppredecessor = null;
  static Node tempsuccessor = null;
  public static void predecessorAndSuccessor(Node node, int data) {
    ...
    temppredecessor = node;
    if(tempsuccessor != null && tempsuccessor.data == data){
        successor = node;
    }
    tempsuccessor = node;
